...
public class CustomTrustManager implements X509TrustManager
{
    ...
    //private static final int DEFAULT_HTTPS_PORT = 8080;

    private String[] hostsToTrust = {"www.cnj.jus.br", "wwwh.cnj.jus.br"};
